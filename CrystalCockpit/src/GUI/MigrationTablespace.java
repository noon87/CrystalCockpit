 ...
 * 
 * Migration Tablespace Description
 * ================================
 * Allow user to migration one or more tablespace at the same time.
 * User can select tablespace name that they want to export/import.
 * This function checking 
 * -	Make sure user fill up all necessary information before process to 
 * execute script. If information is not enough to execute script show dialog 
 * box to user interface let user to fill up necessary information.
 ...
 * “Export Tablespace”: allow user to export dump file(.dmp) for backup data or 
 * for migration to same/other database.
 * “Import Tablespace”: allow user to import data from dump file (.dmp) to current database.
 * 
 * How Function work
 * =================
 ...
 * show log file on user interface.
 * 
 * When user click on "Select All", system select all the check box from Tablespace
 * Table.
 * 
 ...
 * 
 */
public class MigrationTablespace extends javax.swing.JPanel {

    /**
     * Creates new form MigrationTablespace
     */
    public MigrationTablespace() {
        initComponents();
        progressBar.setVisible(false);
        showImpLogFile.setEnabled(false);
        showExpLogFile.setEnabled(false);
        currentTbsName.setEnabled(false);
    ...
    private void initComponents() {
        ...
        currentTbsName = new javax.swing.JTextField();
        ...
        delTBS.setText("Click Here to Delete Tablespace");
        delTBS.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        delTBS.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                delTBSMouseClicked(evt);
            }
        });
        ...
        jTabbedPane1.addTab("Export Tablespace", expPanel);
            ...
            .addGroup(impPanel1Layout.createSequentialGroup()
                ...
                .addGroup(impPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(impPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(currentTbsName, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(edit)))
        ...
        impPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, impPanel1Layout.createSequentialGroup()
                ...
                .addGroup(impPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(currentTbsName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(edit)
                    .addComponent(jLabel3))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane1.addTab("Import Tablespace", impPanel1);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(dumpFile, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(createNewDir)
                                .addComponent(dir, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE)))
                   ...
                   int reply = JOptionPane.showConfirmDialog(null, "Are you sure "
                    ...
                    if(reply == JOptionPane.YES_OPTION){
                        ...
                        if(tmpName.length()!= 0 && expLog.getText().length()!=0 &&
                            ...
                            currentTbsName.setText(tbsName);
                   ...
                   int reply = JOptionPane.showConfirmDialog(null, "Are you sure "
                    ...
                    if(reply == JOptionPane.YES_OPTION){
                        if(impLog.getText().length()!=0 && usernameImp.getText().length() != 0
                            ...
                            && dumpFile.getText().length() != 0
                            && dir.getSelectedItem()!= "--Please Select One--"
                            && currentTbsName.getText().length()!=0
                            ...
                            if(check3 == true){
                                ...
                                tbsName = currentTbsName.getText();
                                SwingWorker sw = new SwingWorker<Boolean,Integer>(){
                                    protected Boolean doInBackground()throws Exception{
                                        progressBar.setVisible(true);
                                        publish(0);
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        currentTbsName.setEnabled(true);
    ...
    private void delTBSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delTBSMouseClicked
        GUI.MainFrame.deleteTablespaceItem.doClick();
    }//GEN-LAST:event_delTBSMouseClicked
    ...
    private void retrieveDataFromDB(){
        ...
        ArrayList<String> tbsList = new ArrayList<String>();
        tbsList.addAll(thisController.arrList);
        ...
        for(int i = 0; i<tbsList.size();i++){
            model.addRow(new Object[]{tbsList.get(i),false});
        }
    ...
    private void actions(){
          Boolean check = false;
          if(choice == 1){
              check = thisController.connectCmd("expTbs");
          }else if(choice == 2){
              check = thisController.connectCmd("impTbs");
          }
          if(check == false){
    ...
    public static javax.swing.JTextField currentTbsName;
    public static javax.swing.JTextField dbImp;
    private javax.swing.JButton deSelectAll;
    private javax.swing.JLabel delTBS;
