 ...
 * ===================================
 * Allow user to migration one or more schema at the same time.
 * User can select schema name that they want to export/import.
 ...
 * "Export Schema”: allow user to export dump file(.dmp) for backup data or for 
 * migration to same/other database.
 * “Import Schema”: allow user to import data from dump file (.dmp) to current database.
 * 
 * How Function work
 * =================
 ...
 * show log file on user interface.
 * 
 * When user click on "Select All", system select all the check box from Schema
 * Table.
 * 
 * When user click on "DeSelect All", system un-select all the check box from
 * Schema Table.
 * 
 ...
 * 
 */
public class MigrationSchema extends javax.swing.JPanel {

    /**
     * Creates new form MigrationSchema
     */
    public MigrationSchema() {
        ...
        currentScehmaName.setEnabled(false);
    ...
    private void initComponents() {
        ...
        expSchema = new javax.swing.JButton();
        ...
        impSchema = new javax.swing.JButton();
        showImpLogFile = new javax.swing.JButton();
        currentScehmaName = new javax.swing.JTextField();
        ...
        expSchema.setText("Export");
        expSchema.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                expSchemaActionPerformed(evt);
            }
        });
        expSchema.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                expSchemaKeyPressed(evt);
            }
        });
        ...
        delUser.setText("Click Here to Delete Schema");
        delUser.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jTabbedPane1.addTab("Export Schema", expPanel);
        ...
        impSchema.setText("Import");
        impSchema.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                impSchemaActionPerformed(evt);
            }
        });
        impSchema.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                impSchemaKeyPressed(evt);
            }
        });
        ...
        impPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(impPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(impPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(impPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addGap(18, 18, 18)
                        .addComponent(currentScehmaName, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(edit))
                    .addGroup(impPanel1Layout.createSequentialGroup()
                        .addComponent(showImpLogFile)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(impSchema))
                    .addGroup(impPanel1Layout.createSequentialGroup()
        ...
        impPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, impPanel1Layout.createSequentialGroup()
                ...
                .addGroup(impPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(currentScehmaName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(edit)
                    .addComponent(jLabel3))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(importIntoCurrentDb)
        ...
        jTabbedPane1.addTab("Import Schema", impPanel1);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(createNewDir, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(31, 31, 31)))
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(dir, javax.swing.GroupLayout.PREFERRED_SIZE, 294, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(dumpFile, javax.swing.GroupLayout.PREFERRED_SIZE, 294, javax.swing.GroupLayout.PREFERRED_SIZE)))))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel2)
                            .addComponent(dir, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void expSchemaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_expSchemaActionPerformed
                   ...
                   int reply = JOptionPane.showConfirmDialog(null, "Are you sure "
                    ...
                    if(reply == JOptionPane.YES_OPTION){
                        ...
                        if(tmpName.length()!= 0 && expLog.getText().length()!=0 &&
                            ...
                            currentScehmaName.setText(schemaName);
    ...
    }//GEN-LAST:event_expSchemaActionPerformed

    private void impSchemaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_impSchemaActionPerformed
                   ...
                   int reply = JOptionPane.showConfirmDialog(null, "Are you sure "
                    ...
                    if(reply == JOptionPane.YES_OPTION){
                        if(impLog.getText().length()!=0 && usernameImp.getText().length() != 0 
                                ...
                                && dumpFile.getText().length() != 0
                                && dir.getSelectedItem()!= "--Please Select One--"
                                && currentScehmaName.getText().length()!=0
                            ...
                            if(check3 == true){
                                ...
                                impSchema.setEnabled(false);
                                schemaName = currentScehmaName.getText();
                                SwingWorker sw = new SwingWorker<Boolean,Integer>(){
                                    protected Boolean doInBackground()throws Exception{
                                        progressBar.setVisible(true);
                                        publish(0);
    ...
    }//GEN-LAST:event_impSchemaActionPerformed
    ...
    private void expSchemaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_expSchemaKeyPressed
         if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            expSchema.doClick();
        }
    }//GEN-LAST:event_expSchemaKeyPressed
    ...
    private void impSchemaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_impSchemaKeyPressed
         if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            impSchema.doClick();
        }
    }//GEN-LAST:event_impSchemaKeyPressed
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        currentScehmaName.setEnabled(true);
    ...
    private void delUserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delUserMouseClicked
        GUI.MainFrame.deleteUserItem.doClick();
    ...
    private void retrieveDataFromDB(){
        ...
        schemaList.addAll(thisController.arrList);
        ...
        for(int i = 0; i<schemaList.size();i++){
            model.addRow(new Object[]{schemaList.get(i),false});
        }
        usernameImp.setText(thisController.name);
    }
    ...
    private void actions(){
          ...
          Boolean check = false;
          if(choice == 1){
              check = thisController.connectCmd("expSchema");
          }else if(choice == 2){
  
              check = thisController.connectCmd("impSchema");
          }
          if(check == false){
    ...
    private void enableExpPanel(boolean value){
        ...
        expSchema.setEnabled(value);
        createNewDir.setVisible(value);
        delUser.setVisible(value);
    }
    ...
    public static javax.swing.JTextField currentScehmaName;
    ...
    private javax.swing.JButton expSchema;
    ...
    private javax.swing.JButton impSchema;
